...
object Rule {
  ...
  case class PartiallyMatched[I <: HList, O <: HList](continuation: (Boolean) ⇒ Rule[I, O]) extends Rule[I, O]
  ...
  def partiallyMatched[I <: HList, O <: HList](continuation: (Boolean) ⇒ Rule[I, O]): Rule[I, O] =
